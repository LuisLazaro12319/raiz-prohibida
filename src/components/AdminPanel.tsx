  ...
  return (
    <div className="rounded-xl border border-borde bg-superficie/40 p-4 sm:col-span-2">
      ...
      <p className="mt-0.5 text-xs text-tenue">
        Subí las fotos del producto y marcá en qué colores lo tenés. La foto no cambia según el color — la clienta elige el color aparte al hacer el pedido.
      </p>
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <Campo label="Nombre" placeholder="Ej: Set Girly Rosa" />
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="grid gap-4">
                  <Campo label="Etiqueta de arriba" valor="Lencería · Lima, Perú" />
                  <Campo label="Título" valor="Siéntete auténtica y poderosa" />
              ...
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    <Campo label="Texto" area valor={`Sets de lencería al mejor precio y calidad. Accedé a precio mayorista desde solo ${MINIMO_MAYORISTA} unidades.`} />
                  </div>
                </div>
                <p className="mt-3 rounded-lg bg-acento/10 px-3 py-2 text-[11px] text-tenue">
          ...
          {vista === "config" && (
            <div className="rounded-xl border border-borde bg-background p-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Campo label="Rubro" valor="Lencería" />
