...
/**
 * Bandera peruana dibujada a mano.
 *
 * No se usa el emoji 🇵🇪 porque Windows no dibuja las banderas: en vez de la
 * bandera muestra las letras "PE", y la mayoría de los clientes de escritorio
 * están en Windows.
 */
function BanderaPeru() {
  return (
    ...
    >
      ...
      <rect width="9" height="18" fill="#D91023" />
      <rect x="18" width="9" height="18" fill="#D91023" />
    </svg>
  );
}
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="text-sm">
          ...
          <p className="mt-3 text-tenue">
            Envíos a todo el país <BanderaPeru />
          </p>
        </div>
